<!-- BEGIN PAGE HEADER-->
			...
			<div class="row margin-top-20">
				<div class="col-md-12">
					...
					<div class="profile-content" id="edit-data-process" disabled>
						<div class="row">
							<div class="col-md-12">
...
<hr>
                ...
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="note note-info">
                         ...
                         <i class="fa fa-info-circle"></i> Pastikan ekstensi data foto : <strong> .png|.jpg|.gif</strong> dan Max ukuran file : <strong> 2 MB</strong> .
                          ...
                          <div class="form-group">
                            <div id="data-upload-siswa" class="fileinput fileinput-new" data-provides="fileinput">
					...
					if (file_exists('raport_files/foto/siswa/full/'.$profilesiswa->siswa_foto)) {
						echo site_url().'raport_files/foto/siswa/full/'.$this->session->userdata('user_photo');
					} else {
