<!-- BEGIN PAGE HEADER -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('') ?>guru/dashboard">Dashboard</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<a class="more" href="<?php echo site_url() ?>guru/datasiswa/siswaaktif">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense">
						...
						<a class="more" href="<?php echo site_url() ?>guru/dataguru/lihatdata">
						View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<a class="more" href="<?php echo site_url() ?>guru/datakelas">
						View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
								 +<?php echo $jumlah_absensi_all?>
							</div>
							<div class="desc">
								 Data Absensi
							</div>
						</div>
						<a class="more" href="<?php echo site_url() ?>guru/dataabsensi/lihatdata">
						View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
