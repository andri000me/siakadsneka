<?php
class Siswaraport_Controller extends MY_Controller
{
	...
	function __construct ()
	{
		...
		$this->data['jumlah_kompetensi'] = $this->count_m->hitungkompetensi_client();
		$this->data['jumlah_absensi'] = $this->count_m->hitungabsensi_client();
		...
		$this->data['namasiswa'] = $this->siswa_m->namasiswa();
