...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisikapsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaisikap/input_nilaisiswa_edit')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      ...
      {
        $.post("<?php echo site_url('guru/datanilaisikap/cari_kelas_modal')?>/" + res, {} ,function(obj){
   ...
   var str = $('#nilai-kelas').val();
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.post("<?php echo site_url('guru/datanilaisikap/cari_semesterwali')?>/" + str, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaisikap/download_formnilai')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaisikap/download_formnilai_hasil')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/hapus_nilai')?>",
        type: "POST",
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/generate_formnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/validasiformnilai_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/upload_nilai_excel_edit')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/edit_multi_nilai')?>",
        type: "POST",
...
<!-- SCRIPT DATA NILAI SIKAP EDIT GURU -->