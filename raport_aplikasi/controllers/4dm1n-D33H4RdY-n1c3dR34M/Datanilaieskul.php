<?php
class Datanilaieskul extends Adminraport_Controller {
    ...
    public function wajib_input_nilai() {
    	...
    	$this->data['subview'] = 'admin/datanilaieskul/Wajib_InputNilai';
     ...
     public function wajib_edit_nilai() {
        ...
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
        //Load Data View Data Nilai Input UH
        $this->data['subview'] = 'admin/datanilaieskul/Wajib_EditNilai';
        $this->load->view('admin/admindesain', $this->data);
    ...
    public function nonwajib_input_nilai() {
      $this->data['data_angkatan_aktif2'] = $this->siswa_m->get_data_angkatan_aktif2();
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
      //Load Data View Data Nilai Input UH
      $this->data['subview'] = 'admin/datanilaieskul/NonWajib_InputNilai';
      $this->load->view('admin/admindesain', $this->data);
     ...
     public function nonwajib_edit_nilai() {
        ...
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
        //Load Data View Data Nilai Input UH
        $this->data['subview'] = 'admin/datanilaieskul/NonWajib_EditNilai';
        $this->load->view('admin/admindesain', $this->data);
    ...
    public function nonwajib_input_nilai_v2() {
    	$this->data['data_angkatan_aktif2'] = $this->siswa_m->get_data_angkatan_aktif2();
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
    	//Load Data View Data Nilai Input eskul non wajib
    	$this->data['subview'] = 'admin/datanilaieskul/NonWajib_InputNilai_v2';
    	$this->load->view('admin/admindesain', $this->data);
     ...
     public function nonwajib_edit_nilai_v2() {
        $this->data['data_angkatan_aktif2'] = $this->siswa_m->get_data_angkatan_aktif2();
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
        //Load Data View Data Nilai Input 
        $this->data['subview'] = 'admin/datanilaieskul/NonWajib_EditNilai_v2';
        $this->load->view('admin/admindesain', $this->data);
    ...
    public function download_formnilai_nonwajib_hasil_v2() {
   ...
   if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
     ...
     private function jumlahnilai($kelas, $semester, $jenis, $mapel)
    {
        ...
        $query = $this->db->query('SELECT COUNT(DISTINCT(nilai_jenis)) as jumlah FROM `raport_nilai` WHERE nilai_kelas="'.$this->db->escape_str($kelas).'" AND nilai_semester="'.$this->db->escape_str($semester).'" AND nilai_eskul="'.$this->db->escape_str($mapel).'" AND  nilai_jenis LIKE "'.$jenis.'%"');
      if ($query->num_rows() > 0)
        {
        $row = $query->row();
   ...
   private function get_datanilai_siswa_alumni_nonwajib($pesertatahunajaran, $pesertadataeskul, $nilaitahunajaran, $nilaidataeskul, $nilaisemester) {
    ...
    public function cari_kelas_modal( $id = NULL) {
      ...
      if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
           $data   = $this->nilaieskul_m->get_data_eskul2_nonwajib($semester5dan6);
           $tahunajaran = '<optgroup label="Eskul Non Wajib TH :'.$semester5dan6.'">';
      } elseif ($this->input->post('nilai_cari_semester') == 3 || $this->input->post('nilai_cari_semester') == 4) {
          $data   = $this->nilaieskul_m->get_data_eskul2_nonwajib($semester3dan4);
          $tahunajaran = '<optgroup label="Eskul Non Wajib TH :'.$semester3dan4.'">';
      } elseif ($this->input->post('nilai_cari_semester') == 1 || $this->input->post('nilai_cari_semester') == 2) {
          $data   = $this->nilaieskul_m->get_data_eskul2_nonwajib($semester1dan2);
     ...
     public function cari_eskul_nonwajib_edit_v2() {
        $dataangkatan = substr($this->input->post('nilai_cari_angkatan'), 0 , 4);
        $semester5dan6 = $dataangkatan.'/'.($dataangkatan+1);
        $semester3dan4 = ($dataangkatan-1).'/'.$dataangkatan;
        $semester1dan2 = ($dataangkatan-2).'/'.($dataangkatan-1);
     ...
     public function cari_eskuledit() {
      ...
      if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
           $data   = $this->nilaieskul_m->get_data_eskuledit($this->input->post('nilai_cari_kelas'),$this->input->post('nilai_cari_semester'),$semester5dan6);
           $tahunajaran = '<optgroup label="Eskul Wajib TH :'.$semester5dan6.'">';
      } elseif ($this->input->post('nilai_cari_semester') == 3 || $this->input->post('nilai_cari_semester') == 4) {
          $data   = $this->nilaieskul_m->get_data_eskuledit($this->input->post('nilai_cari_kelas'),$this->input->post('nilai_cari_semester'),$semester3dan4);
          $tahunajaran = '<optgroup label="Eskul Wajib TH :'.$semester3dan4.'">';
      } elseif ($this->input->post('nilai_cari_semester') == 1 || $this->input->post('nilai_cari_semester') == 2) {
          $data   = $this->nilaieskul_m->get_data_eskuledit($this->input->post('nilai_cari_kelas'),$this->input->post('nilai_cari_semester'),$semester1dan2);
          $tahunajaran = '<optgroup label="Eskul Wajib TH :'.$semester1dan2.'">';
      } else {
          $data   = $this->nilaieskul_m->get_data_eskuledit($this->input->post('nilai_cari_kelas'),$this->input->post('nilai_cari_semester'),$semester5dan6);
          $tahunajaran = '<optgroup label="Eskul Wajib TH :'.$semester5dan6.'">';
      ...
      if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
        ...
        foreach ($list as $siswa) {
           ...
           // $row[] = '<input type="checkbox" class="checkboxes" value="1"/>';
            ...
            $row[] =  '<h4><span  style="font-size:15px" class="label label-primary tooltips" data-placement="top" data-original-title="'.$siswa->siswa_kelas .' - '. $siswa->kelas_kk.' - '.$siswa->kelas_tahun.'">'. $datanamakelas.'</span></h4>';
            //$row[] =  '<h4><span class="badge bg-red">'. $siswa->siswa_absen. '</span></h4>';
             $row[] =  form_dropdown('siswa_nis['.$siswa->pesertaeskul_nis.']', array('' => '', 'A' => 'AMAT BAIK', 'B' => 'BAIK', 'C' => 'CUKUP', 'D' => 'KURANG'),$siswa->pesertaeskul_nis,'class="class-data-nilai-siswa form-control select2me input-nilai-eskul" data-placeholder="Pilih Nilai"  id="data-nilai-siswa"');
...
public function nonwajib_input_nilaisiswa_edit() {
      ...
      if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
        ...
        foreach ($list as $siswa) {
           ...
           // $row[] = '<input type="checkbox" class="checkboxes" value="1"/>';
            ...
            $row[] =  '<h4><span  style="font-size:15px" class="label label-primary tooltips" data-placement="top" data-original-title="'.$siswa->siswa_kelas .' - '. $siswa->kelas_kk.' - '.$siswa->kelas_tahun.'">'. $datanamakelas.'</span></h4>';
            //$row[] =  '<h4><span class="badge bg-red">'. $siswa->siswa_absen. '</span></h4>';
             $row[] =  form_dropdown('siswa_nis['.$siswa->siswa_nis.']', array('' => '', 'A' => 'AMAT BAIK', 'B' => 'BAIK', 'C' => 'CUKUP', 'D' => 'KURANG'), $siswa->nilaieskul_data, 'class="class-data-nilai-siswa form-control select2me input-nilai-eskul" data-placeholder="Pilih Nilai"  id="data-nilai-siswa"');
    ...
    public function nonwajib_input_nilaisiswa_edit_v2() {
    ...
    function upload_nilai_excel_edit_nonwajib_v2() {
        ...
        $this->_validatenilai_nonwajib_edit_v2();
    ...
    public function validasiformnilai_nonwajib_edit_v2() {
        $this->_validatenilai_nonwajib_edit_v2();
        $this->_validatenilai_edit2_nonwajib_v2();
        $this->_validate_nilai_cari_nonwajib_v2();
    ...
    private function _validatenilai_nonwajib_edit_v2()
    {
        $data = array();
        $data['error_string'] = array();
        $data['inputerror'] = array();
    ...
    public function hapus_nilai_nonwajib_edit_v2() {
