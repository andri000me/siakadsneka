...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#password').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('siswa/password/ajax_list_siswa')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#tahun-cari').on( 'change', function () {   // for select box
    ...
    table
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('siswa/password/cari_kelas')?>/" + res, {} ,function(obj){
		$('#kelas-cari').html(obj);
		});
...
function kirim_email_selected()
{
    ...
    if (dataemail.length == 0 ) { 
        ...
        //Metronic.unblockUI('#process-selected-password');
         ...
         $.ajax({
        url : "<?php echo site_url('siswa/password/ajax_email_selected_siswa')?>/" + dataemail[diyanahhardy],
        type: "GET",
        dataType: "JSON",
...
function kirim_sms_selected()
{
    ...
    if (datasms.length == 0 ) { 
        ...
        Metronic.unblockUI('#process-selected-password');
         ...
         $.ajax({
        url : "<?php echo site_url('siswa/password/ajax_sms_selected_siswa')?>/" + datasms[diyanahhardy],
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {   
...
function edit_password(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/password/ajax_edit_siswa')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/password/ajax_update_siswa')?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "JSON",
        success: function(data)
...
function kirim_email(id)
{
    ...
    {	
        ...
        $.ajax({
            url : "<?php echo site_url() ?>siswa/password/ajax_email_siswa/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function kirim_sms(id)
{
    ...
    {	
        ...
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url() ?>siswa/password/ajax_sms_siswa/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
