<?php
class Datanilai extends Adminraport_Controller {
    ...
    public function input_nilai() {
      ...
      $this->data['subview'] = 'admin/datanilai/InputNilai';
     ...
     public function edit_nilai() {
        ...
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2();
        //Load Data View Data Nilai Input UH
        $this->data['subview'] = 'admin/datanilai/EditNilai';
        $this->load->view('admin/admindesain', $this->data);
      ...
      if ($this->input->post('nilai_cari_category') == 'nilai_raport') {
           if ($this->input->post('nilai_cari_aspek') == 'RAPORT_P') {
            ...
            if ($this->input->post('nilai_cari_aspek') == 'UH') {
               ...
               $jumlahnilai = '';
            } elseif ($this->input->post('nilai_cari_aspek') == 'PS') {
   ...
   if(!empty($datamapel)){
    ...
    private function nilairaport($kelas, $semester, $mapel, $aspek)
    {
        ...
        $query = $this->db->query('SELECT COUNT(DISTINCT(nilai_jenis)) as jumlah FROM `raport_nilai` WHERE nilai_kelas="'.$this->db->escape_str($kelas).'" AND nilai_semester="'.$this->db->escape_str($semester).'" AND nilai_mapel="'.$this->db->escape_str($mapel).'" AND nilai_jenis LIKE "'.$aspek.'"');
      if ($query->num_rows() > 0)
        {
        $row = $query->row();
     ...
     private function nilairaport2($kelas, $semester, $mapel)
    {
        ...
        $query = $this->db->query('SELECT COUNT(DISTINCT(nilai_jenis)) as jumlah FROM `raport_nilai` WHERE nilai_kelas="'.$this->db->escape_str($kelas).'" AND nilai_semester="'.$this->db->escape_str($semester).'" AND nilai_mapel="'.$this->db->escape_str($mapel).'" AND nilai_jenis LIKE "RAPORT%"');
      if ($query->num_rows() > 0)
        {
        $row = $query->row();
    ...
    public function cari_kelas_modal( $id = NULL) {
      ...
      if ($this->input->post('nilai_cari_semester') == 5 || $this->input->post('nilai_cari_semester') == 6 ) {
           $data   = $this->nilai_m->get_data_mapel2_global();
      ...
      public function cari_mapel2() {
        ...
        $query = $this->db->query('SELECT mapel_id, mapel_nama FROM raport_nilai LEFT JOIN raport_mapel ON raport_mapel.mapel_id = raport_nilai.nilai_mapel WHERE nilai_kelas='.$this->db->escape_str($kelas).' AND nilai_semester="'.$this->db->escape_str($semester).'"');
                ...
                echo  '<option value=""></option>
                    ...
                    <option value="RAPORT_K">Nilai Keterampilan</option>
                     ...
                     <optgroup label="Nilai Berproses: Aspek Pengetahuan">
                        ...
                        <optgroup label="Nilai Berproses: Aspek Keterampilan">
                        <option value="PS">Nilai Proses</option>
                        <option value="PR">Nilai Produk</option>
                        <option value="PO">Nilai Proyek</option>
                        </optgroup>
                    ';
            } else {
       ...
       if($this->input->post('nilai_cari_mapel') == '')
        ...
        if ($this->input->post('nilai_cari_category') == 'nilai_raport') {
           ...
           if ($this->nilairaport($this->input->post('nilai_cari_kelas'), $this->input->post('nilai_cari_semester'), $this->input->post('nilai_cari_mapel'), $this->input->post('nilai_cari_aspek')) >= 1) {
                 $data['inputerror'][] = 'nilai_cari_category';
                $data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Data nilai pada mapel : <b>'.$this->get_namamapel($this->input->post('nilai_cari_mapel')).'</b>, kelas <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).':'.$this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, pada <b> semester '.$this->input->post('nilai_cari_semester').' </b>, sudah memiliki <b> '.$aspeknilai.' </b>, untuk menghapus nilai klik <b><a href="'.site_url().'/4dm1n-D33H4RdY-n1c3dR34M/datanilai/edit_nilai" target="_blank">menu ini</a></b>.';
                $data['status'] = FALSE;
           }
        ...
        if ($this->input->post('nilai_cari_category') == 'nilai_pks') {
            if ($this->nilairaport2($this->input->post('nilai_cari_kelas'), $this->input->post('nilai_cari_semester'), $this->input->post('nilai_cari_mapel')) >= 1) {
                 $data['inputerror'][] = 'nilai_cari_category';
                $data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Data nilai pada mapel : <b>'.$this->get_namamapel($this->input->post('nilai_cari_mapel')).'</b> kelas <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).':'.$this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b> pada <b> semester '.$this->input->post('nilai_cari_semester').' </b>, sedang memproses <b> NILAI AKHIR RAPORT </b>, untuk menghapus nilai klik <b><a href="'.site_url().'/4dm1n-D33H4RdY-n1c3dR34M/datanilai/edit_nilai" target="_blank">menu ini</a></b>.';
                $data['status'] = FALSE;
           }
        }
        */
      ...
      private function _validate_nilai_cari()
    {
        ...
        if ($this->input->post('nilai_cari_category') == 'nilai_pks') {
              if($this->input->post('nilai_cari_aspek') !== 'UH' && $this->input->post('nilai_cari_aspek') !== 'TG' && $this->input->post('nilai_cari_aspek') !== 'UTS' && $this->input->post('nilai_cari_aspek') !== 'UAS' && $this->input->post('nilai_cari_aspek') !== 'PS' && $this->input->post('nilai_cari_aspek') !== 'PR' && $this->input->post('nilai_cari_aspek') !== 'PO'  )
            {
                $data['inputerror'][] = 'data_masuk';
      ...
      private function _validate_nilai_cari_edit()
    {
        ...
        */
              ...
              if($this->input->post('nilai_cari_aspek') !== 'UH' && $this->input->post('nilai_cari_aspek') !== 'TG' && $this->input->post('nilai_cari_aspek') !== 'UTS' && $this->input->post('nilai_cari_aspek') !== 'UAS' && $this->input->post('nilai_cari_aspek') !== 'PS' && $this->input->post('nilai_cari_aspek') !== 'PR' && $this->input->post('nilai_cari_aspek') !== 'PO' && $this->input->post('nilai_cari_aspek') !== 'RAPORT_P' && $this->input->post('nilai_cari_aspek') !== 'RAPORT_K' && $this->input->post('nilai_cari_aspek') !== 'RAPORT_S')
            {
                $data['inputerror'][] = 'data_masuk';
                $data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Aspek <b>data nilai</b> yang anda masukkan <b>tidak valid</b>.';
                $data['status'] = FALSE;
    ...
    private function cekdatanilai($mapel, $semester, $kelas, $jenis)
    {
        ...
        $query = $this->db->query('SELECT count(DISTINCT(nilai_jenis)) as jumlah FROM raport_nilai WHERE nilai_mapel="'.$this->db->escape_str($mapel).'" AND nilai_semester="'.$this->db->escape_str($semester).'" AND nilai_kelas="'.$this->db->escape_str($kelas).'" AND nilai_jenis="'.$this->db->escape_str($jenis).'"');
        //$query = $this->db->get();
       ...
       private function cekdatanilairaport($mapel, $semester, $kelas)
    {
        ...
        $query = $this->db->query('SELECT count(DISTINCT(nilai_jenis)) as jumlah FROM raport_nilai WHERE nilai_mapel="'.$this->db->escape_str($mapel).'" AND nilai_semester="'.$this->db->escape_str($semester).'" AND nilai_kelas="'.$this->db->escape_str($kelas).'" AND nilai_jenis LIKE "RAPORT%"');
        //$query = $this->db->get();
