   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#datasiswaaktif').DataTable({
        ...
        buttons: [
           {
               extend: 'print',
               title: 'Data Siswa Aktif - SMK N 1 Magelang',
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datasiswa/ajax_list_siswa_aktif')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#tahun-cari').on( 'change', function () {   // for select box
    ...
    table
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datasiswa/cari_kelas_aktif')?>/" + res, {} ,function(obj){
		$('#kelas-cari').html(obj);
		});
