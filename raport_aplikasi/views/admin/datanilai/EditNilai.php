<!-- BEGIN PAGE HEADER-->
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="portlet light bordered" id="cek-nilai-process">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil-square"></i>Edit Nilai Mapel
							</div>
							<div class="tools">
                ...
                echo form_open(site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilai/download_formnilai_edit'),$attributes); 
            ?>
							<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
												...
												<select name="nilai_cari_aspek" class="form-control select2me" data-placeholder="Aspek Nilai" id="nilai-aspek-edit">
												<option value=""></option>
									...
									<div class="col-md-4">
										<div class="form-group">
												...
												<select name="nilai_cari_data" class="form-control select2me" data-placeholder="Data Nilai" id="nilai-data" disabled>
												<option value=""></option>
								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
									<button onclick="cekformnilai()" type="button" class="btn grey-cascade"><i class="fa fa-tasks"></i> Edit Nilai Siswa</button>
