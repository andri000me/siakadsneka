...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisikapsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
function download_form() {
       ...
       $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/download_formnilai3')?>",
        type: "POST",
        ...
        success: function()
        {
             ...
             window.location="<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/download_formnilai3')?>"; 
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/validasiformnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/upload_nilai_excel')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
    ...
    var barisdatanilaisikap = $('#datanilaisikapsiswa tbody tr td:nth-child(2) input').map(function()
             {
             return parseInt($(this).val());
            }).get();

    $('#datanilaisikap-masuk').val(barisdatanilaisikap);
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
    
     $.ajax({
        url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/simpan_multi_nilai",
        type: "POST",
