...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#datasiswaaktif').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datasiswa/ajax_list_siswa_aktif')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#tahun-cari').on( 'change', function () {   // for select box
    ...
    table
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('guru/datasiswa/cari_kelas_aktif')?>/" + res, {} ,function(obj){
		$('#kelas-cari').html(obj);
		});
...
function lihat_data_siswa(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datasiswa/lihat_data_siswa')?>/" + id,
        type: "GET",
        dataType: "JSON",
