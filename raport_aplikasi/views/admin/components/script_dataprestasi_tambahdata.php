...
jQuery(document).ready(function() {
    ...
    $("#data-kelas-aktif2").change(function() {   // for select box
    ...
    $('#data-siswa-aktif2').prop('disabled', true);
    $("#data-siswa-aktif2").val('').trigger("change");
    $("#data-kelas-aktif2").val('').trigger("change");
    $("#data-bidang-prestasi").val('').trigger("change");
    $("#data-peringkat-prestasi").val('').trigger("change");
    $("#data-tingkat-prestasi").val('').trigger("change");
    $('#form2')[0].reset();
...
Metronic.blockUI({
   ...
   $('#btnSave').text(' Tambah Data...').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataprestasi/ajax_tambah')?>",
        type: "POST",
        ...
        success: function(data)
        {
            ...
            $('#btnSave').text(' Tambah Prestasi').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
        ...
        {	
            ...
            DataPesanError4();
            $('#btnSave').text(' Tambah Prestasi'); //change button text
            $('#btnSave').attr('disabled',false); //set button enable
            //location.reload();
...
<!-- SCRIPTS DATA PRESTASI TAMBAH DATA -->