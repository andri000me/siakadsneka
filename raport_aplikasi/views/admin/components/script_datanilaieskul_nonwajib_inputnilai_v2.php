...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/nonwajib_input_nilaisiswa_v2')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/cari_eskul_nonwajib_v2')?>",
        type: "POST",
...
function download_form() {
       ...
       $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/download_formnilai_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        success: function()
        {
             ...
             window.location="<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/download_formnilai_nonwajib_v2')?>"; 
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/validasiformnilai_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/upload_nilai_excel_nonwajib_v2')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/simpan_multi_nilai_nonwajib_v2",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL INPUT (WAJIB) -->