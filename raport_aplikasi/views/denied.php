...
<link href="<?php echo site_url('')?>raport_themes/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<div class="row">
	<div class="col-md-12 page-500">
		...
		<div class=" details">
			<h3>Oops! Anda tidak berhak masuk di halaman yang akan anda akses tadi.</h3>
			<p>
				 Aktivitas anda telah masuk di data record server!<br/>
				Jika terdapat aktivitas yang mencurigakan, Admin berhak untuk menghapus akun anda !!!<br/><br/>
			</p>
		</div>
	</div>
</div>
