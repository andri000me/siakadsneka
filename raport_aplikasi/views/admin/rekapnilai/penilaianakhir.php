			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="portlet light bordered" id="cek-rekap-process">
						...
						<div class="portlet-body">
							...
							<?php
							                ...
							                echo form_open(site_url('4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/download_nilaiakhir'),$attributes); 
							            ?>
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-tasks"></i>Rekap Penilaian Akhir
							</div>
