<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Rekap Penilaian Berproses : <b><?php echo $namakelas ?></b>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Rekap Penilaian : <?php echo $namakelas ?></a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="portlet light bordered" id="cek-rekap-process">
						...
						<div class="portlet-body">
							...
							<?php
							                ...
							                echo form_open(site_url('guru/rekapnilaiwali/download_nilaiberproses'),$attributes); 
							            ?>
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-tasks"></i>Rekap Penilaian Berproses : <b><?php echo $namakelas ?></b>
							</div>
