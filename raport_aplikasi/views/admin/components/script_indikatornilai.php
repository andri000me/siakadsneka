...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#dataindikatornilai').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/indikatornilai/ajax_list_indikator_nilai')?>",
            "type": "POST",
             "data" : {
                         indikator_tahun ( d ) {
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/indikatornilai/cari_indikator",
        type: "POST",
