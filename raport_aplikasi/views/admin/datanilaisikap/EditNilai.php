<!-- BEGIN PAGE HEADER-->
			...
			<div class="row">
                ...
                echo form_open(site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/download_formnilai'),$attributes); 
            ?>				<input id="datanilaisikap-hapus" name="data_hapus" type="hidden" >
							<div class="row">
								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
									<button onclick="cekformnilai()" type="button" class="btn grey-cascade"><i class="fa fa-tasks"></i> Edit Nilai Sikap </button>
