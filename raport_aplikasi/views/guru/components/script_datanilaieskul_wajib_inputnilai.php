...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaieskul/input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/cari_eskul_wajib')?>",
        type: "POST",
...
function download_form() {
       ...
       $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/download_formnilai3')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        success: function()
        {
             ...
             window.location="<?php echo site_url('guru/datanilaieskul/download_formnilai3')?>"; 
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/validasiformnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/upload_nilai_excel')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url() ?>guru/datanilaieskul/simpan_multi_nilai",
        type: "POST",
