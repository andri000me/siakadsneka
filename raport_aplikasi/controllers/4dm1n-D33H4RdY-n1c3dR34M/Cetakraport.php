<?php
class Cetakraport extends Adminraport_Controller
{
    ...
    public function cover_html($nis = null)
    {
        ...
        if ($this->siswa_m->cekdatanis($this->uri->segment(4)) == false) {
            show_404(uri_string());
        }
    ...
    public function SMT_pdf($semester = null, $nis = null)
    {
        ...
        $mpdf->SetDisplayMode('fullpage');
        //$mpdf = new mPDF('','',0,'', 30,10);
        //$mpdf->SetHTMLFooter('<b><i>Halo Mas Bro</i></b>');
        //$mpdf->useOddEven = 1;
    ...
    //     echo $this->barcode->barcode_data('916125-SM1-XIIEB');
    // }

    


    public function cekbrohehe($semester = null, $nis = null)
    {
   ...
   -
    ...
    private function raport_kelompok_C2($semester, $tahun, $nis)
    {
        ...
        if(($this->uri->segment(5) == 1 || $this->uri->segment(5) == 2) && $this->uri->segment(6) == 'v2') {
           $groupC2 = 'C2. Dasar Program Keahlian';
           $fontSize = '10';
        }
        ...
        if (!empty($data1)) {
            ...
            $tmp .= '<tr style="mso-yfti-irow:2;height:21.9pt">
                        ...
                        21.9pt">
                        <p class=MsoNormal style="margin-bottom:0in;margin-bottom:.0001pt;
                        line-height:normal"><span class=SpellE><b><span style="font-size:'.$fontSize.'.0pt;
                        mso-ascii-font-family:Calibri;mso-ascii-theme-font:minor-latin;mso-hansi-font-family:
                        Calibri;mso-hansi-theme-font:minor-latin">'. $groupC2 .'</span></b></span><b><span
        ...
        if (!empty($data1)) {
            ...
            foreach ($data1 as $row) {
                ...
                if($datanilai == '' || $datadeskripsi == '') {
                    ...
                    .0001pt;text-align:center;line-height:normal" align="center"><span style="font-size:10.0pt">'.$no.'.</span></p>
                    </td>
