...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilai/input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-category').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.ajax({
        url : "<?php echo site_url('guru/datanilai/cari_aspek_input')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        success: function(result)
        {
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('guru/datanilai/generate_formnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilai/validasiformnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilai/upload_nilai_excel')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url() ?>guru/datanilai/simpan_multi_nilai",
        type: "POST",
...
<!-- SCRIPT DATA NILAI INPUT NILAI MAPEL GURU-->