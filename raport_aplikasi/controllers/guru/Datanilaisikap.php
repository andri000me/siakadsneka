<?php
class Datanilaisikap extends Gururaport_Controller {
    ...
    public function input_nilai() {
        $this->data['data_angkatan_aktif2'] = $this->siswa_m->get_data_angkatan_aktif2_wali();
        $this->data['data_angkatan_tidakaktif2'] = $this->siswa_m->get_data_angkatan2_wali();
        //Load Data View Data Nilai Input UH
        if (count($this->wali_m->statuswali())) {
            $this->data['subview'] = 'guru/datanilaisikap/InputNilai';
        } else {
            $this->data['subview'] = 'guru/accessdenied/InputNilaiSikap_wali';
        }
     ...
     public function edit_nilai() {
        ...
        //Load Data View Data Nilai Input UH
        if (count($this->wali_m->statuswali())) {
             $this->data['subview'] = 'guru/datanilaisikap/EditNilai';
        } else {
            $this->data['subview'] = 'guru/accessdenied/EditNilaiSikap_wali';
        }
       ...
       if ($this->input->post('nilai_cari_semester') == 1 || $this->input->post('nilai_cari_semester') == 3 || $this->input->post('nilai_cari_semester') == 5 ) {
        ...
        $datakelas = $this->get_datakelas($this->input->post('nilai_cari_kelas'));
          ...
          $objPHPExcel->setActiveSheetIndex(0)
            ...
            if ($this->cekkodekelaswali_fix($this->input->post('nilai_cari_angkatan'), $this->input->post('nilai_cari_kelas'), $this->input->post('nilai_cari_semester')) == 1) {
            ...
            $objPHPExcel->getActiveSheet()->mergeCells('A13:F13');
             ...
             $objPHPExcel->getActiveSheet()->mergeCells('A13:F13');
              ...
              $objPHPExcel->setActiveSheetIndex(0)
                                        ->setCellValue('A13', 'MAAF ANDA TIDAK MEMILIKI HAK UNTUK MENGAKSES NILAI SIKAP KELAS INI');
    ...
    private function kodekelaswali() {
    ...
    public function cari_kelas_modal( $id = NULL) {
      ...
      $tmp  = '';
        $data   = $this->siswa_m->get_data_kelas_modal_wali($id);
        if(!empty($data)){
      ...
      public function cari_semesterwali($id) {

        $datatahun = substr($this->get_kelastahunwali($id), 0, 4) - substr($this->konfigurasi_m->konfig_tahun_client(), 0 , 4);
        ...
        if ($datatahun == 2) {
             ...
             echo '<option value=""></option><option value="3">Semester 3</option> <option value="4">Semester 4</option>';
        } elseif ($datatahun == 0) {

            echo '<option value=""></option><option value="5">Semester 5</option> <option value="6">Semester 6</option>';
            
        } else {

            echo '<option value=""></option><option value="Semester Tidak Tersedia">Semester Tidak Tersedia</option>';
        }
    ...
    private function get_kelastahunwali($id) {
    ...
    /*
    private function ambildata($where){
  ...
  public function cobaya() {
    $this->ambildata(array(
      'user_login' => '1418683',
      'user_password' => $this->user_m->hash('sawangan'),
    ), TRUE);
    dump($this->db->last_query());
  }
  public function cobaya2() {
        $this->ambildata2('1418683',$this->user_m->hash('sawangan'));
        dump($this->db->last_query());
  }

  public function cobaya3() {
        $this->ambildata2('1418683',$this->user_m->hash('sawangan'));
        dump($this->db->last_query());
  }

  private function ambildata2($user, $password) {
    $query = $this->db->query('SELECT `siswa_nama`, `siswa_foto` FROM `raport_siswa` LEFT JOIN `raport_users` ON `raport_users`.`user_login`=`raport_siswa`.`siswa_nis` WHERE `user_login` = '.$this->db->escape($user).' AND `user_password` = '.$this->db->escape($password).'');
  }
    ...
    */
           ...
           $did = intval($id);
            ...
            if ($this->input->post('siswa_deskripsi['.$did.']') == '') {
             ...
             $data = array(
               ...
               'nilaisikap_kodeguru' => $this->session->userdata('user_login'),
      ...
      private function _validate_nilai_cari()
    {
        ...
        $datatahun = substr($this->get_kelastahunwali($this->input->post('nilai_cari_kelas')), 0, 4) - substr($this->konfigurasi_m->konfig_tahun_client(), 0 , 4);
        ...
        if($this->cekkodekelaswali_fix($this->input->post('nilai_cari_angkatan'), $this->input->post('nilai_cari_kelas'), $this->input->post('nilai_cari_semester')) !== 1) {
            $data['inputerror'][] = 'data_masuk';
            $data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Maaf saat ini anda tidak memiliki <b>hak untuk mengakses</b> data nilai sikap kelas : <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).'</b> : <b>'. $this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, pada tahun ajaran : <b>'.$this->konfigurasi_m->konfig_tahun_client().'</b>';
            $data['status'] = FALSE;
        ...
        //if ($this->cekkodekelaswali() !== $this->input->post('nilai_cari_kelas')) {
        // $data['inputerror'][] = 'data_masuk';
          //  $data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Maaf anda tidak memiliki <b>hak untuk mengakses</b> data nilai sikap kelas : <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).'</b> : <b>'. $this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, pada tahun ajaran : <b>'.$this->konfigurasi_m->konfig_tahun_client().'</b>';
            //$data['status'] = FALSE;


        //}

        //if ($this->cekkodekelaswali() == $this->input->post('nilai_cari_kelas') && $datatahun == 2 ) {
          //  if ($this->input->post('nilai_cari_semester') !== '1' && $this->input->post('nilai_cari_semester') !== '2' ) {
              //  $data['inputerror'][] = 'data_masuk';
            //$data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Maaf anda hanya <b>memiliki hak akses</b> data nilai sikap pada kelas : <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).'</b> : <b>'. $this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, untuk <b>semester 1</b> dan <b>semester 2</b>.';
            //$data['status'] = FALSE;
            //}
        //}

        //if ($this->cekkodekelaswali() == $this->input->post('nilai_cari_kelas') && $datatahun == 1 ) {
            //if ($this->input->post('nilai_cari_semester') !== '3' && $this->input->post('nilai_cari_semester') !== '4' ) {
                //$data['inputerror'][] = 'data_masuk';
            //$data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Maaf anda hanya <b>memiliki hak akses</b> data nilai sikap pada kelas : <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).'</b> : <b>'. $this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, untuk <b>semester 3</b> dan <b>semester 4</b>.';
            //$data['status'] = FALSE;
            //}
        //}

         //if ($this->cekkodekelaswali() == $this->input->post('nilai_cari_kelas') && $datatahun == 0 ) {
           // if ($this->input->post('nilai_cari_semester') !== '5' && $this->input->post('nilai_cari_semester') !== '6' ) {
             //   $data['inputerror'][] = 'data_masuk';
            //$data['error_string'][] = '<i class="fa fa-warning"></i> <strong>Warning:</strong> Maaf anda hanya <b>memiliki hak akses</b> data nilai sikap pada kelas : <b>'.$this->get_namakelas($this->input->post('nilai_cari_kelas')).'</b> : <b>'. $this->get_tahunkelas($this->input->post('nilai_cari_kelas')).'</b>, untuk <b>semester 5</b> dan <b>semester 6</b>.';
            //$data['status'] = FALSE;
            //}
        //}
      ...
      private function cekkodekelaswali() {
    ...
    private function cekkodekelaswali_fix($dataangkatan, $datakelas, $semester) {
      ...
      if ($semester == 5 || $semester == 6 ) {
        ...
        $query = $this->db->query('SELECT * FROM raport_wali WHERE wali_kodeguru="'.$this->session->userdata('user_login').'" AND wali_tahunajaran="'.$this->db->escape_str($tahunajaran).'" AND wali_kelas="'.$this->db->escape_str($datakelas).'" AND wali_status="1" ');
