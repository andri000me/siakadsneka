<?php
class Indikatornilai extends Siswaraport_Controller {
    ...
    public function index() {
        ...
        $this->data['subview'] = 'siswa/datanilai/Indikatornilai';
     ...
     public function ajax_list_indikator_nilai()
    {
      ...
      $dataangkatan = substr($this->indikatornilai_m->tahunkelas(), 0 , 4);
      ...
      if ($this->input->post('indikator_semester') == 5 || $this->input->post('indikator_semester') == 6 ) {
        ...
        $list = $this->indikatornilai_m->get_datatables_data_nilai_siswa($this->indikatornilai_m->datakelas(), $this->input->post('indikator_semester'), $tahunajaran);
        $data = array();
        ...
        $output = array(
                        ...
                        "recordsTotal" => $this->indikatornilai_m->count_all_data_nilai_siswa($this->indikatornilai_m->datakelas(), $this->input->post('indikator_semester'), $tahunajaran),
                        "recordsFiltered" => $this->indikatornilai_m->count_filtered_data_nilai_siswa($this->indikatornilai_m->datakelas(), $this->input->post('indikator_semester'), $tahunajaran),
                        "data" => $data,
                );
    ...
    public function cari_indikator() {
      ...
      if ($this->input->post('indikator-semester') == 1 || $this->input->post('indikator-semester') == 3 || $this->input->post('indikator-semester') == 5 ) {
        ...
        $rekapdata = $this->indikatornilai_m->count_all_data_nilai_siswa($this->indikatornilai_m->datakelas(), $this->input->post('indikator-semester'), $tahunajaran);
     ...
     private function cekdatatahun($angkatan)
    {
     ...
     public function cari_semester_siswa() {
        ...
        $tmp  = '';
        $data   = $this->siswa_m->get_data_semester_modal_siswa();
