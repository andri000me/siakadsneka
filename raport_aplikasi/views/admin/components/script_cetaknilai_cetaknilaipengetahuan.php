...
<script type="text/javascript" src="<?php echo site_url('')?>raport_themes/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>
...
<!-- SCRIPTS CETAK NILAI CETAK NILAI PENGETAHUAN -->