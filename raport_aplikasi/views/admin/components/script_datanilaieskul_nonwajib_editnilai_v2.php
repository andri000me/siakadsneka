...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/nonwajib_input_nilaisiswa_edit_v2')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      ...
      {
        $.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/cari_kelas_modal')?>/" + res, {} ,function(obj){
   ...
   var str = $('#nilai-kelas').val();
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/cari_semester')?>/" + str, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/cari_eskul_nonwajib_edit_v2')?>",
        type: "POST",
...
$('#nilai-eskul').click(function() {   // for select box
    ...
    $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/download_formnilai_nonwajib_v2')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/download_formnilai_nonwajib_hasil_v2')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/hapus_nilai_nonwajib_edit_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/generate_formnilai_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/validasiformnilai_nonwajib_edit_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/upload_nilai_excel_edit_nonwajib_v2')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/edit_multi_nilai_nonwajib_v2')?>",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL EDIT (WAJIB)-->