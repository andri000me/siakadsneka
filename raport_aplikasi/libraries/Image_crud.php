...
class image_CRUD {
	...
	protected $default_language_path = 'assets/assets/image_crud/languages';
	...
	{
		$this->css_files[sha1($css_file)] = base_url().'assets/'.$css_file;
	}

	public function set_js($js_file)
	{
		$this->js_files[sha1($js_file)] = base_url().'assets/'.$js_file;
	}
	...
	protected function _library_view($view, $vars = array(), $return = FALSE)
	{
		...
		$view_file = 'assets/assets/image_crud/views/';
    ...
    protected function _get_delete_url($value)
    {
    	...
    	return site_url('c0sm1de-admin00/'.$rsegments_array[1].'/delete_file/'.$value);
    }
	...
	{
		include('assets/assets/image_crud/config/translit_chars.php');
	...
	protected function getState()
	{
		...
		{
			$upload_url = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/upload_file/'.$rsegments_array[3]);
			$ajax_list_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/'.$rsegments_array[3].'/ajax_list');
			$ordering_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/ordering');
			$insert_title_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/insert_title');
		...
		{
			$upload_url = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/upload_file');
			$ajax_list_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/ajax_list');
			$ordering_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/ordering');
			$insert_title_url  = site_url('c0sm1de-admin00/'.$rsegments_array[1].'/insert_title');
