<!-- BEGIN PAGE HEADER-->
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="portlet light bordered" id="cek-nilai-process">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil-square"></i>Edit Nilai Eskul (Wajib)
							</div>
							<div class="tools">
                ...
                echo form_open(site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/download_formnilai'),$attributes); 
