...
Email: ofanidariyan@hotmail.com
Twitter: www.twitter.com/OfaniDariyan
Facebook : www.facebook.com/harwisaw
-->
...
<head>
<meta charset="utf-8"/>
<title>Dashboard : <?php echo $namaguru ?>- <?php echo $meta_title; ?></title>
...
<!-- BEGIN PAGE STYLES -->
<link href="<?php echo site_url('')?>raport_themes/assets/admin/pages/css/tasks.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
...
<link href="<?php echo site_url('')?>raport_themes/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
