                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <input type="hidden" value="" name="user_id"/> 
                    	...
                    	<div class="form-group">
                            <label class="control-label col-md-3">Guru Login*</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                         ...
                                         <input name="guru_kode" class="form-control" placeholder="Guru Login" type="text" disabled>
                                        </div>
...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#password').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/password/ajax_list_guru')?>",
            "type": "POST",
             "timeout": 15000,
          ...
          $('td:eq(2),td:eq(4),td:eq(5)', nRow).addClass( "raport-mapel" );
...
function kirim_email_selected()
{
    ...
    if (dataemail.length == 0 ) { 
        ...
        $("#respose").append('<div id="remove-notif-kosong" class="alert alert-danger alert-dismissable fade in"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button> <i class="fa fa-warning"></i> <strong>Warning: </strong> Anda belum melakukan seleksi data <b>user guru</b> yang akan dikirim.</div>');
        ...
        //Metronic.unblockUI('#process-selected-password');
         ...
         $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/password/ajax_email_selected')?>/" + dataemail[diyanahhardy],
        type: "GET",
        dataType: "JSON",
...
function kirim_sms_selected()
{
    ...
    if (datasms.length == 0 ) { 
        ...
        Metronic.unblockUI('#process-selected-password');
         ...
         $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/password/ajax_sms_selected')?>/" + datasms[diyanahhardy],
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {   
...
function edit_password(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/password/ajax_edit_guru')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Password Guru'); // Set title to Bootstrap modal title
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/password/ajax_update_guru')?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "JSON",
        success: function(data)
...
function kirim_email(id)
{
    ...
    {	
        ...
        $.ajax({
            url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/password/ajax_email/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function kirim_sms(id)
{
    ...
    {	
        ...
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/password/ajax_sms/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
