...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#dataindikatornilai').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/indikatornilai/ajax_list_indikator_nilai')?>",
            "type": "POST",
             "data" : {
                         indikator_tahun ( d ) {
    ...
    $('#semester-cari-modal').prop('disabled', true);
...
$('#kelas-cari-modal').click(function() {   // for select box
      
   var str = $('#kelas-cari-modal').val();
      var tahun = $('#tahun-cari-modal').val();
...
$('#semester-cari-modal').click(function() {   // for select box
    ...
    //$("input[name='checkAll']").click(function() {
                ...
                //$("#dataindikatornilai tbody tr td div span input:checkbox").attr("checked", checked);
                //$("#dataindikatornilai tbody tr td div span").attr("checked", checked);
            //});
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>guru/indikatornilai/cari_indikator",
        type: "POST",
...
<!-- SCRIPT INDIKATOR REKAP NILAI GURU -->