...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    var generate_tabel_nilaiberproses = function(){
        ...
        $.ajax({
                url : "<?php echo site_url('guru/rekapnilaiwali/jumlah_kolom')?>",
                type: "POST",
  ...
  $.ajax({
                url : "<?php echo site_url('guru/rekapnilaiwali/ambil_tabel')?>",
                data: $('#form-rekap-nilai').serialize(),
                type: "POST",
                dataType: "JSON",
    ...
    //dom: '<lf<tr>ip>',
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/rekapnilaiwali/ajax_list_berproses')?>",
            "type": "POST",
             "data" : {
...
$('#rekap_semester').click(function() {   // for select box
    ...
    $('#rekap_mapel').prop('disabled', true);
      ...
      {
       $.ajax({
        url : "<?php echo site_url('guru/rekapnilaiwali/cari_mapel')?>",
        type: "POST",
        data: $('#form-rekap-nilai').serialize(),
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>guru/rekapnilaiwali/cari_rekapnilai_berproses",
        type: "POST",
        data: $('#form-rekap-nilai').serialize(),
        dataType: "JSON",
        success: function(data)
            ...
            {   
                 Metronic.unblockUI('#cek-rekap-process');
                  ...
                  if (data.pesannotif == 'sukses') {
                    $('#data-download').append('<div class="form-group" id="file-download-nilai"><div class="form-actions noborder"><button type="submit" class="btn green-meadow"><i class="fa fa-file-excel-o"></i> Download Nilai</button></div></div>');
                  }
...
<!-- SCRIPTS DATA REKAP PENILAIAN BERPROSES WALI -->