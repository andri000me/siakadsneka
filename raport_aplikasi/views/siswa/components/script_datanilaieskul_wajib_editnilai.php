...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('siswa/datanilaieskul/input_nilaisiswa_edit')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      ...
      {
        $.post("<?php echo site_url('siswa/datanilaieskul/cari_kelas_modal_wajib')?>/" + res, {} ,function(obj){
...
$('#nilai-kelas').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.post("<?php echo site_url('siswa/datanilaieskul/cari_semester_wajib')?>/" + str + "/" + datatahun, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/cari_eskuledit')?>",
        type: "POST",
...
$('#nilai-eskul').click(function() {   // for select box
    ...
    $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('siswa/datanilaieskul/download_formnilai')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('siswa/datanilaieskul/download_formnilai_hasil')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/hapus_nilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/generate_formnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/validasiformnilai_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/upload_nilai_excel_edit')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('siswa/datanilaieskul/edit_multi_nilai')?>",
        type: "POST",
