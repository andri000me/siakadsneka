...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#datamapel').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('siswa/datamapel/ajax_list')?>",
            "type": "POST",
 ...
 $('.group-checkable').change(function() {
    ...
    // return  false;
    $.ajax({
        url: '<?php echo site_url('siswa/datamapel/ajax_multiple_delete')?>',
        type: 'post',
...
function save()
{
   ...
   $('#btnSave').text(' Tambah Data...').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datamapel/ajax_add')?>",
        type: "POST",
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datamapel/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
{   
    ...
    // ajax update data to database
    $.ajax({
        url : "<?php echo site_url('siswa/datamapel/ajax_update')?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "JSON",
        success: function(data)
