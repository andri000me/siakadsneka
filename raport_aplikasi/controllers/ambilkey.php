...
class Ambilkey extends CI_Controller
{
    ...
    public function index()
    {
    	...
    	$passwordgeneratekuat = $this->generateStrongPassword(50);
        echo $fanicode->encode($passwordgeneratekuat, 'wogIPkyWCsxGjlLlPn4FyLZXEEXkBCzdIC23cXhb7Y7JuBW8SBlcxIGf/sqF5tIyAcCUmM5T/O4fIRA1luw1DLt263v9s6xwdldqqFBIPNkd1mHwZMqAzTKkIdOmpP4f');
    }
