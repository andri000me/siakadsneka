<?php
class Rangking extends Siswaraport_Controller {
    ...
    public function rangkingkelas() {
    	...
    	$this->data['subview'] = 'siswa/rangking/rangkingkelas';
     ...
     public function ajax_list_rank()
    {
      ...
      if ($this->input->post('rank_semester') == 5 || $this->input->post('rank_semester') == 6 ) {
        ...
        if ($this->input->post('semester_cari') == '') {
          ...
          $list = $this->rangking_m->get_datatables_data_rank($this->indikatornilai_m->datakelas(), $this->input->post('semester_cari'));
        ...
        $output = array(
                        ...
                        "recordsTotal" => $this->rangking_m->count_all_data_rank($this->indikatornilai_m->datakelas(), $this->input->post('semester_cari')),
                        "recordsFiltered" => $this->rangking_m->count_filtered_data_rank($this->indikatornilai_m->datakelas(), $this->input->post('semester_cari')),
                        "data" => $data,
                );
