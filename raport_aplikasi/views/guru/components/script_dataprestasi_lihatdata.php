...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#dataprestasi').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/dataprestasi/ajax_list')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#data-kelas-aktif').on( 'change', function () {   // for select box
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('guru/dataprestasi/cari_siswa_aktif')?>/" + str, {} ,function(obj){
...
<!-- SCRIPTS DATA PRESTASI LIHAT DATA GURU-->