...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/nonwajib_input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/cari_eskul_nonwajib')?>",
        type: "POST",
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/validasiformnilai_nonwajib')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/upload_nilai_excel_nonwajib')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
     ...
     Metronic.blockUI({
                ...
                boxed: true,
                message: 'Proses Menyimpan Nilai...',
                cenrerY: true,
                animate: false
            });

    var barisdatanilaieskul = $('#datanilaieskulsiswa tbody tr td:nth-child(2) input').map(function()
             {
             return parseInt($(this).val());
            }).get();

    $('#datanilaieskul-masuk').val(barisdatanilaieskul);
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
    
     $.ajax({
        url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/datanilaieskul/simpan_multi_nilai_nonwajib",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL INPUT (NON WAJIB)-->