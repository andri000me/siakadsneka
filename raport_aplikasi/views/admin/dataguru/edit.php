			...
			<h4 class="form-section">Data Options</h4>
                 ...
                 <div class="col-md-4">
										<div class="form-group">
											...
											<option value="B">Akutansi</option>
											<option value="E">Admistrasi Perkantoran</option>
											<option value="L">Pemasaran</option>
											<option value="M">Teknik Komputer Jaringan</option>
