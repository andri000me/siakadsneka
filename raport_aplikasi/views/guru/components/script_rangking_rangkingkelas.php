...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#rankingsiswakelas').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/rangking/ajax_list_rank')?>",
            "type": "POST",
              "data" : {
                      tahun_cari ( d ) {
...
$.post("<?php echo site_url('guru/indikatornilai/cari_semester_siswa')?>/", {} ,function(obj){
...
<!-- SCRIPTS DATA RANGKING KELAS GURU WALI -->