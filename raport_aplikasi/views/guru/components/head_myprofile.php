...
<head>
<meta charset="utf-8"/>
<title>My Profile : <?php echo $namaguru ?> - Sistem Informasi Nilai Raport V.1</title>
...
<link href="<?php echo site_url() ?>raport_themes/assets/admin/pages/css/profile.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url() ?>/raport_themes/assets/global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url() ?>/raport_themes/assets/admin/pages/css/portfolio.css" rel="stylesheet" type="text/css"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo site_url('')?>raport_themes/assets/global/plugins/bootstrap-select/bootstrap-select.min.css"/>
...
<link href="<?php echo site_url('')?>raport_themes/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css"/>
