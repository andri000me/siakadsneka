...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaieskul/nonwajib_input_nilaisiswa_edit')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      ...
      {
        $.post("<?php echo site_url('guru/datanilaieskul/cari_semester_non_wajib')?>/" + res, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/cari_eskul_nonwajib_edit')?>",
        type: "POST",
...
$('#nilai-eskul').click(function() {   // for select box
  ...
  $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaieskul/download_formnilai_nonwajib')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaieskul/download_formnilai_nonwajib_hasil')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/hapus_nilai_nonwajib_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/generate_formnilai_nonwajib')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/validasiformnilai_nonwajib_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/upload_nilai_excel_nonwajib_edit')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/edit_multi_nilai_nonwajib')?>",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL EDIT (NON WAJIB) GURU-->