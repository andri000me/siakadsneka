...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#rekapnilaiakhir').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/rekapnilaiwali/ajax_list_rekap')?>",
            "type": "POST",
             "data" : {
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>guru/rekapnilaiwali/cari_rekapnilai_akhir",
        type: "POST",
        data: $('#form-rekap-nilai').serialize(),
        dataType: "JSON",
...
<!-- SCRIPTS Data Rekap Penilaian Akhir Wali -->