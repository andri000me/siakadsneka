...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('siswa/datanilai/input_nilaisiswa_edit')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-mapel').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      else
      {
         ...
         $.ajax({
        url : "<?php echo site_url('siswa/datanilai/cari_aspek')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        success: function(result)
        {
...
$('#nilai-aspek-edit').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      else
      {
           ...
           $.ajax({
        url : "<?php echo site_url('siswa/datanilai/cari_data_nilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        success: function(result)
        {
...
$('#data-download').click(function() {   // for select box
  ...
  $("#form-nilai-cari").attr({
            "action" : "<?php echo site_url('siswa/datanilai/download_formnilai_edit')?>"
            });
} );
...
$('#data-download-nilai').click(function() {   // for select box
  ...
  $("#form-nilai-cari").attr({
            "action" : "<?php echo site_url('siswa/datanilai/download_formnilai_edit_hasil')?>"
            });
} );
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('siswa/datanilai/generate_formnilai_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilai/hapus_nilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilai/validasiformnilai_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('siswa/datanilai/upload_nilai_excel_edit')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('siswa/datanilai/edit_multi_nilai')?>",
        type: "POST",
