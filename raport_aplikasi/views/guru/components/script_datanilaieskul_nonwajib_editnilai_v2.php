...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaieskul/input_nilaisiswa_edit_nonwajib_v2')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      ...
      {
        $.post("<?php echo site_url('guru/datanilaieskul/cari_kelas_modal_nonwajib_v2')?>/" + res, {} ,function(obj){
...
$('#nilai-kelas').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.post("<?php echo site_url('guru/datanilaieskul/cari_semester_nonwajib_v2')?>/" + str + "/" + datatahun, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/cari_eskuledit_nonwajib_v2')?>",
        type: "POST",
...
$('#nilai-eskul').click(function() {   // for select box
    ...
    $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaieskul/download_formnilai_nonwajib_v2')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('guru/datanilaieskul/download_formnilai_hasil_nonwajib_v2')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/hapus_nilai_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
        {
               ...
               if (data.status) {
                 ...
                 window.setTimeout(function() {
                    ...
                    $('#form-upload-excel').remove();
                    $('#generate-datanilaieskul').remove();
                    $('#data-generate-formnilai').remove();
                   table.columns(4).search('').draw();
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/generate_formnilai_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/validasiformnilai_edit_nonwajib_v2')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/upload_nilai_excel_edit_nonwajib_v2')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/edit_multi_nilai_nonwajib_v2')?>",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL EDIT (WAJIB) GURU-->