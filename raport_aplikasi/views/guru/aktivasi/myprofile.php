				...
				<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="portlet light">
									...
									<div class="col-md-12">
										<div class="form-group">
												...
												<input name="guru_nama" class="form-control" placeholder="Nama Guru" type="text" disabled>
											</div>
														</div>
									</div>
								...
								<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
												...
												<input name="guru_nip" class="form-control" placeholder="NIP" type="text" id="mask_nipguru" disabled>
											</div>
														</div>
									</div>
								...
								<div class="col-md-6">
										<div class="form-group">
												...
												<input name="guru_email" class="form-control" placeholder="Email" type="text" disabled>
											</div>
														</div>
									</div>
								<div class="col-md-6">
										<div class="form-group">
												...
												<select name="guru_agama" class="form-control select2me" data-placeholder="Pilih Agama" id="guru-agama" disabled>
												<option value=""></option>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
												...
												<input name="guru_notelp" class="form-control" placeholder="No Handphone" type="text" id="mask_notelpguru" disabled>
											</div>
														</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
												...
												<select name="guru_jeniskelamin" class="form-control select2me" data-placeholder="Jenis Kelamin" id="guru-jeniskelamin" disabled>
												<option value=""></option>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
												...
												<input name="guru_tempatlahir" class="form-control" placeholder="Tempat Lahir" type="text" disabled>
											</div>
														</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
												...
												<input name="guru_tanggallahir" class="form-control date-picker" placeholder="yyyy-mm-dd" type="text" id="guru-tanggal" disabled>
								...
								<div class="row">
										...
										<div class="form-group">
												...
												<input name="guru_asaluniv" class="form-control" placeholder="Asal Universitas" type="text" disabled>
											</div>
														</div>
									</div>
								...
								<div class="row">
										...
										<div class="form-group">
												...
												<input name="guru_jurusan" class="form-control" placeholder="Jurusan" type="text" disabled>
											</div>
														</div>
									</div>
										<div class="col-md-6">
										<div class="form-group">
												...
												<select name="guru_jenjang" class="form-control select2me" data-placeholder="Pendidikan" id="guru-pendidikan" disabled>
												<option value=""></option>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="guru_alamat" class="form-control" rows="2" disabled></textarea>
                 ...
                 <div class="col-md-6">
										<div class="form-group">
												...
												<select name="guru_kelompok" class="form-control select2me" data-placeholder="Pilih Kelompok" id="guru-kelompok" disabled>
												<option value=""></option>
                 ...
                 <div class="col-md-6">
										<div class="form-group">
												...
												<select name="guru_group" class="form-control select2me" data-placeholder="Pilih Group" id="guru-group" disabled>
												<option value=""></option>
               	...
               	<div class="row">
										...
										<div class="form-group">
												...
												<input name="guru_tugas" class="form-control" placeholder="Tugas Jabatan" type="text" disabled>
											</div>
														</div>
									</div>
								...
								<div class="col-md-12">
										<div class="form-group">
												...
												<input name="guru_mengajar" class="form-control" placeholder="Ex: Bahasa Indonesia" type="text" disabled>
											</div>
														</div>
									</div>
