        ...
        <div class="modal-content">
            ...
            <div class="modal-body form" id="edit-data-process">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                    <input type="hidden" value="" name="wali_id"/> 
                     <input type="hidden" value="" name="wali_kelascek" id="kelas-cek"/> 
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                           ...
                                           <?php $attributes = array('name' => 'wali_kodeguru', 'class' => 'form-control select2me', 'data-placeholder' => 'Pilih Guru Wali', 'id' => 'data-select2-raport3');
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                            ...
                                            <select name="wali_kelas" placeholder="Pilih Kelas" class="form-control select2me" id="data-select2-raport4">
                                            <option value=""></option>
...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#datawali').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_list')?>",
            "type": "POST",
             "timeout": 15000,
    ...
    //$("input[name='checkAll']").click(function() {
                ...
                //$("#datawali tbody tr td div span input:checkbox").attr("checked", checked);
                //$("#datawali tbody tr td div span").attr("checked", checked);
            //});
            
 $('.group-checkable').change(function() {
                var set = $("#datawali tbody tr td div span input:checkbox");
                var checked = $(this).is(":checked");
                $(set).each(function() {
    ...
    // return  false;
    $.ajax({
        url: '<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_multiple_delete')?>',
        type: 'post',
...
function save()
{
   ...
   $('#btnSave').text(' Tambah Data...').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
    ...
    // ajax update data to database
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_add')?>",
        type: "POST",
        ...
        success: function(data)
        {
            ...
            $('#btnSave').text(' Tambah Wali').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="wali_id"]').val(data.wali_id);
            $('[name="wali_kodeguru"]').val(data.wali_kodeguru);
            $('[name="wali_kelas"]').val(data.wali_kelas);
            $('[name="wali_status"]').val(data.wali_status);

            $("#data-select2-raport3").val(data.wali_kodeguru).trigger("change");
            ...
            $('.modal-title').text('Edit Wali'); // Set title to Bootstrap modal title
...
{   
    ...
    // ajax update data to database
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_update')?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "JSON",
        success: function(data)
...
function delete_data(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datawali/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
