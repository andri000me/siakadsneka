...
<head>
    ...
    <meta charset="utf-8">
    <title>E-Raport | <?php echo strtoupper($this->konfigurasi_m->konfig_sekolah()) ?></title>
                    ...
                    <div class="row mb15 table-layout">
                        ...
                        <div class="col-xs-6 va-m pln">
                            <a href="<?php echo site_url() ?>" title="Return to Dashboard">
                                <img src="<?php echo site_url() ?>raport_themes/login/assets/img/logos/logo-login-new.png" title="E-Raport <?php echo strtoupper($this->konfigurasi_m->konfig_sekolah()) ?>" class="img-responsive w250">
                            </a>
                        </div>
                        ...
                        <?php echo form_open();?>
                            <div class="panel-body bg-light p30">
                                ...
                                <div class="col-sm-5 br-grey pl30" style="text-align: center; padding-left: 45px !important; padding-top: 10px !important; color: #364150">
                                    ...
                                    <img class="page-lock-img" src="<?php echo site_url() ?>raport_themes/login/assets/img/sneka.png" alt="">
                                    ...
                                    <?php echo validation_errors(); ?>
                                        ...
                                        <div class="section">
                                            ...
                                            <label for="username" class="field prepend-icon">
                                                <input type="text" name="user_login" id="username" class="gui-input" placeholder="Enter username">
