			...
			<div class="row">
				...
				<div class="col-md-12">
                  ...
                  <div class="note note-warning">
                   ...
                   <i class="fa fa-info-circle"></i> <b>Info</b> : Data <b>peserta eskul</b> hanya diperuntukkan bagi siswa yang mengikuti <b>eskul tambahan</b> atau data eskul yang bestatus <b>tidak wajib</b>.
							...
							<input type="hidden" value="" name="pesertaeskul_kelascek" id="kelas-cek2"/> 
							<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
												...
												<select name="pesertaeskul_kelas" placeholder="Pilih Kelas" class="form-control select2me" id="data-kelas-aktif">
											<option value=""></option>
									...
									<div class="col-md-5">
										<div class="form-group">
												...
												<select name="pesertaeskul_nis" class="form-control select2me" data-placeholder="Pilih Siswa" id="data-siswa-aktif" disabled="true">
												<option value=""></option>
									...
									<div class="col-md-3">
										<div class="form-group">
																<label class="control-label">Pilih Eskul*</label>
																<div class="input-group">
												<span class="input-group-addon">
												<i class="fa fa-support"></i>
												</span>
												<select id="data-pilih-eskul" name="pesertaeskul_dataeskul" class="form-control select2me" data-placeholder="Pilih Eskul">
												<option value=""></option>
                  ...
                  <div class="note note-info">
                   ...
                   <i class="fa fa-info-circle"></i> <b>Info</b> : Sistem menampilkan informasi data <b>Peserta Eskul</b>, pada tahun ajaran : <b><?php echo $tahun_ajaran_admin ?></b>, semester : <b> <?php echo ucfirst($semester_admin) ?></b>
