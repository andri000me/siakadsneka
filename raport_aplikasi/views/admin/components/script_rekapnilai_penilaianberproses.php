...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    var generate_tabel_nilaiberproses = function(){
        ...
        $.ajax({
                url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/jumlah_kolom')?>",
                type: "POST",
  ...
  $.ajax({
                url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/ambil_tabel')?>",
                data: $('#form-rekap-nilai').serialize(),
                type: "POST",
                dataType: "JSON",
    ...
    //dom: '<lf<tr>ip>',
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/ajax_list_berproses')?>",
            "type": "POST",
             "data" : {
                      rekap_tahun ( d ) {
           ...
           "drawCallback": function(oSettings) { // run some code on table redraw
                       ...
                       $('.nilaidata-nis').click(function() {   // for select box
                         ...
                         $('.nilaidata').editable({
                            ...
                            url: '<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/simpan_nilai',
                            type: 'text',
                            params: {
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>4dm1n-D33H4RdY-n1c3dR34M/rekapnilai/cari_rekapnilai_berproses",
        type: "POST",
        data: $('#form-rekap-nilai').serialize(),
        dataType: "JSON",
        success: function(data)
