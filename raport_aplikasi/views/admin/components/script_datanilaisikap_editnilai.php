...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisikapsiswa').DataTable({
        //dom: '<lf<tr>ip>',
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/input_nilaisiswa_edit')?>",
            "type": "POST",
             "data" : {
    ...
    if($(this).val() == "")
      {
        ...
        $('#generate-datanilaisikap').remove();
      ...
      {
        $.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/cari_kelas_modal')?>/" + res, {} ,function(obj){
   ...
   var str = $('#nilai-kelas').val();
    ...
    if($(this).val() == "")
      ...
      else
      {
        ...
        $.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/cari_semester')?>/" + str, {} ,function(obj){
...
$('#nilai-semester').click(function() {   // for select box
    ...
    $('#data-download').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/download_formnilai')?>"
                });
    } );
    ...
    $('#data-download-nilai').click(function() {   // for select box
      ...
      $("#form-nilai-cari").attr({
                "action" : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/download_formnilai_hasil')?>"
                });
    } );
...
function hapus_nilai() {
    ...
    var barisdatanilai = $('#datanilaisikapsiswa tbody tr td:nth-child(1) input').map(function()
             {
    ...
    $('#datanilaisikap-hapus').val(barisdatanilai);

    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/hapus_nilai')?>",
        type: "POST",
...
function generate_formnilai() {
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/generate_formnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/validasiformnilai_edit')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/upload_nilai_excel_edit')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function updatenilai() {
    ...
    var barisdatanilai = $('#datanilaisikapsiswa tbody tr td:nth-child(2) input').map(function()
             {
             return parseInt($(this).val());
            }).get();

    $('#datanilaisikap-masuk').val(barisdatanilai);
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
    
     $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/datanilaisikap/edit_multi_nilai')?>",
        type: "POST",
