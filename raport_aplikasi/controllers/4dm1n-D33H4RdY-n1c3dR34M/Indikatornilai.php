<?php
class Indikatornilai extends Adminraport_Controller {
    ...
    public function index() {
        ...
        $this->data['subview'] = 'admin/datanilai/Indikatornilai';
     ...
     public function ajax_list_indikator_nilai()
    {
      ...
      $dataangkatan = substr($this->input->post('indikator_tahun'), 0 , 4);
      ...
      if ($this->input->post('indikator_semester') == 5 || $this->input->post('indikator_semester') == 6 ) {
        ...
        $list = $this->indikatornilai_m->get_datatables_data_nilai($this->input->post('indikator_kelas'), $this->input->post('indikator_semester'), $tahunajaran);
        $data = array();
        ...
        $output = array(
                        ...
                        "recordsTotal" => $this->indikatornilai_m->count_all_data_nilai($this->input->post('indikator_kelas'), $this->input->post('indikator_semester'), $tahunajaran),
                        "recordsFiltered" => $this->indikatornilai_m->count_filtered_data_nilai($this->input->post('indikator_kelas'), $this->input->post('indikator_semester'), $tahunajaran),
                        "data" => $data,
                );
    ...
    public function cari_indikator() {
      ...
      $dataangkatan = substr($this->input->post('indikator-tahun'), 0 , 4);
      $semester5dan6 = $dataangkatan.'/'.($dataangkatan+1);
      $semester3dan4 = ($dataangkatan-1).'/'.$dataangkatan;
      $semester1dan2 = ($dataangkatan-2).'/'.($dataangkatan-1);
      ...
      if ($this->input->post('indikator-semester') == 1 || $this->input->post('indikator-semester') == 3 || $this->input->post('indikator-semester') == 5 ) {
        ...
        $rekapdata = $this->indikatornilai_m->count_all_data_nilai($this->input->post('indikator-kelas'), $this->input->post('indikator-semester'), $tahunajaran);
