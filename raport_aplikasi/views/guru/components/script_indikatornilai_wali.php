...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#dataindikatornilai').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/indikatornilai_wali/ajax_list_indikator_nilai')?>",
            "type": "POST",
             "data" : {
                         indikator_tahun ( d ) {
...
$.post("<?php echo site_url('guru/indikatornilai_wali/cari_semester_siswa')?>/", {} ,function(obj){
...
function cekformindikator() {
    ...
    $.ajax({
        url : "<?php echo site_url() ?>guru/indikatornilai_wali/cari_indikator",
        type: "POST",
...
<!-- SCRIPT DATA MONITOR NILAI GURU WALI -->