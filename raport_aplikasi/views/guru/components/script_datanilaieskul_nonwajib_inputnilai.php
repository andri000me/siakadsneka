...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaieskulsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaieskul/nonwajib_input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
$('#nilai-semester').click(function() {   // for select box
    ...
    if($(this).val() == "")
      ...
      {
       $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/cari_eskul_nonwajib')?>",
        type: "POST",
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/validasiformnilai_nonwajib')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaieskul/upload_nilai_excel_nonwajib')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url() ?>guru/datanilaieskul/simpan_multi_nilai_nonwajib",
        type: "POST",
...
<!-- SCRIPT DATA NILAI ESKUL INPUT (NON WAJIB) GURU-->