...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#datasiswaaktif').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('siswa/datasiswa/ajax_list_siswa_aktif')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#tahun-cari').on( 'change', function () {   // for select box
    ...
    table
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('siswa/datasiswa/cari_kelas_aktif')?>/" + res, {} ,function(obj){
		$('#kelas-cari').html(obj);
		});
...
<!-- SCRIPTS DATA SISWA AKTIF : SISWA-->