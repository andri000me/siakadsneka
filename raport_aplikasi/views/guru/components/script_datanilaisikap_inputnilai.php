...
jQuery(document).ready(function() {
    ...
    table = $('#datanilaisikapsiswa').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('guru/datanilaisikap/input_nilaisiswa')?>",
            "type": "POST",
             "data" : {
...
function download_form() {
       ...
       $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/download_formnilai3')?>",
        type: "POST",
        ...
        success: function()
        {
             ...
             window.location="<?php echo site_url('guru/datanilaisikap/download_formnilai3')?>"; 
...
function cekformnilai() {
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/validasiformnilai')?>",
        type: "POST",
        data: $('#form-nilai-cari').serialize(),
        dataType: "JSON",
        success: function(data)
...
{   
    ...
    $.ajax({
        url : "<?php echo site_url('guru/datanilaisikap/upload_nilai_excel')?>",
        type: "POST",
        data : formData,
        contentType : false,
        processData : false,
...
function savenilai() {
  ...
  $('#btnSave').text(' Memproses Nilai...').prepend(' <i class="fa fa-tasks"></i>'); //change button text
     ...
     $.ajax({
        url : "<?php echo site_url() ?>guru/datanilaisikap/simpan_multi_nilai",
        type: "POST",
...
<!-- SCRIPT DATA NILAI SIKAP INPUT GURU -->