...
jQuery(document).ready(function() {
   ...
   $.fn.dataTable.ext.errMode = 'throw';
    ...
    table = $('#dataabsensi').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_list')?>",
            "type": "POST",
             "timeout": 15000,
...
$('#data-kelas-aktif').on( 'change', function () {   // for select box
		...
		if($(this).val() == "")
  		...
  		{
      	$.post("<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/cari_siswa_aktif')?>/" + str, {} ,function(obj){
...
$("#data-kelas-aktif2").click(function() {   // for select box
 ...
 $('.group-checkable').change(function() {
    ...
    // return  false;
    $.ajax({
        url: '<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_multiple_delete')?>',
        type: 'post',
...
function save()
{
   ...
   $('#btnSave').text(' Tambah Data').prepend(' <i class="fa fa-plus-circle"></i>'); //change button text
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_tambah')?>",
        type: "POST",
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
{   
    ...
    // ajax update data to database
    $.ajax({
        url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_update')?>",
        type: "POST",
        data: $('#form').serialize(),
        dataType: "JSON",
        success: function(data)
...
function delete_data(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('4dm1n-D33H4RdY-n1c3dR34M/dataabsensi/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
